      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Data Barang <a style="float: right;" class="btn btn-primary" href="<?php echo base_url('index.php/admin/barang/tambah');?>" role="button">Tambah</a> </div>
          <div class="card-body">
            ...
            <td><?php echo anchor('admin/barang/edit/'.$row->id_barang,'Edit'); ?> &nbsp; <?php echo anchor('admin/barang/delete/'.$row->id_barang,'Hapus'); ?></td>
			    </tr>
			<?php endforeach; ?>
			  </tbody>
			</table>
