            ...
            <!--<li class="nav-item dropdown no-arrow mx-1">
              ...
              <!--<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="small text-gray-500">23 nov 2018</div>
                    <span class="font-weight-bold">fgdfgsdf</span>
                  </div>
                </a>
                <a class="dropdown-item text-center small text-gray-500" href="<?php echo base_url('index.php/admin/c_transaksi') ?>">Show All Alerts</a>
              </div>
            </li>-->
